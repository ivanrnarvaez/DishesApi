...
public static class DishesHandlers
{
    ...
    public static async Task<Results<NotFound, Ok<DishDto>>> GetDishesByIdAsync(DishesDbContext dishesDbContext,
        IMapper mapper,
        Guid dishId)
    {
    ...
    public static async Task<Ok<DishDto>> GetDishesByNameAsync(DishesDbContext dishesDbContext,
        IMapper mapper,
        string dishName)
    {
